...
$hasil   = $stemmer->stem($filteredarray);
//$st->doStemming($filteredarray)
echo "-><b>".$hasil.'</b><br>';
// }
$konek = mysqli_connect("localhost","root","","dbstbi");
$sql="INSERT INTO dokumentasi (nama_file,token,tokenisasi,tokenisasi2) VALUES('$nama_file','$filteredarray','$hasil','$hasil')";
...
if (move_uploaded_file($lokasi_file,"$folder")){
  ...
  $query = "INSERT INTO upload (nama_file, tgl_upload)
            VALUES('$nama_file','$tgl_upload')";
...
//  echo "bisa";
//  echo '<pre>';
echo '<h4>**---Hasil Proses Tokenisasi---**</h4></br>';
$tekspdf->decodePDF();
//echo $tekspdf->output(); 
